...
export function handleMessageEnd(
  ...
  // Ensure gateway/chat gets final assistant text when provider doesn't stream
  // (e.g. single chunk or message_end-only); server-chat uses this for the final reply.
  if (text) {
    emitAgentEvent({
      runId: ctx.params.runId,
      stream: "assistant",
