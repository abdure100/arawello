...
import { pathForTab, TAB_GROUPS, subtitleForTab, titleForTab } from "./navigation.ts";
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        <section class="content-header">
          ...
          <div class="page-meta">
            ...
            ${
              !state.connected && state.tab !== "overview"
                ? html`<a class="pill session-link" href="${pathForTab("overview", state.basePath)}">Overview – connect</a>`
                : nothing
            }
